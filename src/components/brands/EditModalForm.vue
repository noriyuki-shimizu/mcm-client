    ...
    <div class="uk-modal-dialog uk-modal-body">
      ...
      <div class="uk-section uk-section-muted">
        <div class="uk-container">
          ...
          <form v-on:submit.prevent="registration" class="uk-grid-small" uk-grid>
            ...
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <input id="form-stacked-link" v-model="brandData.link" class="uk-input" type="text">
              </div>
            </div>
        ...
        <div class="uk-width-1-4@s">
          ...
          <div class="uk-form-controls">
            <select id="form-stacked-delete-flg" v-model="brandData.deleteFlag" :disabled="addFlag" class="uk-select">
              <option value="true">
                Deleted
              </option>
              <option value="false">
