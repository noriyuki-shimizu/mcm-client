                ...
                <div class="uk-container">
                    ...
                    >
                        <div class="uk-width-1-2@s">
                            <label
                                class="uk-form-label"
                                for="form-stacked-genre"
                                >Genre</label
                            >
                            <div class="uk-form-controls">
                                <select
                                    id="form-stacked-genre"
                                    v-model="clothesData.genre.id"
                                    class="uk-select"
                                >
                        ...
                        <div class="uk-width-1-2@s">
                            ...
                            <div class="uk-form-controls">
                                <select
                                    id="form-stacked-brand"
                                    v-model="clothesData.brandId"
                                    class="uk-select"
                                >
                                    <option
                        ...
                        <div class="uk-width-1-2@s">
                            ...
                            <div class="uk-form-controls">
                                <select
                                    id="form-stacked-shop"
                                    v-model="clothesData.shopId"
                                    class="uk-select"
                                >
                                    <option
