      ...
      <div class="uk-offcanvas-bar">
        <div class="uk-width-1-1@s uk-width-2-4@m">
          <ul class="uk-nav-default uk-nav-parent-icon" uk-nav>
            <li>
              <router-link to="/home"> <span uk-icon="icon: home" /> Home </router-link>
            </li>
            <li>
              <router-link to="/map"> <span uk-icon="icon: location" /> Map </router-link>
            </li>
            <li class="uk-parent">
              <a href="#"><span uk-icon="icon: user" /> My Clothes</a>
              <ul class="uk-nav-sub">
                <li>
            ...
            <li class="uk-parent">
              <a href="#"><span uk-icon="icon: cog" /> Maintenance</a>
              <ul class="uk-nav-sub">
                <li>
            ...
            <li>
              <a href="https://github.com/noriyuki-shimizu/mcm-client" target="_blank">
                <span class="uk-margin-small-right" uk-icon="icon: github" />Git
              </a>
            </li>
            <li class="uk-nav-divider" />
            <li>
              <a @click="signout" href="#">
                <span class="uk-margin-small-right" uk-icon="icon:  sign-out" />Signout
              </a>
            </li>
          </ul>
        </div>
