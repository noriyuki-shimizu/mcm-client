  ...
  <div class="shop-search-form">
    <div class="uk-section uk-section-muted">
      <div class="uk-container">
        <h3>Search form</h3>
        <form v-on:submit.prevent="search" class="uk-grid-small" uk-grid>
          <div class="uk-width-1-2@s">
            <label class="uk-form-label" for="form-stacked-shop-name">Shop name</label>
            <div class="uk-form-controls">
              <input id="form-stacked-shop-name" v-model="shopDto.name" type="text">
            </div>
          </div>
          ...
          <div class="uk-width-1-1">
            ...
            <div class="uk-form-controls">
              <input id="form-stacked-address" v-model="shopDto.address" type="text">
            </div>
          </div>
          ...
          <div class="uk-width-1-4@s">
            ...
            <div class="uk-form-controls">
              <select id="form-stacked-delete-flg" v-model="shopDto.deleteFlag" class="uk-select">
                <option value="true">
                  Deleted
                </option>
                <option value="false">
