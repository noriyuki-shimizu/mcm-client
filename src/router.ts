        ...
        },
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    name: 'clothes-list',
                    component: () =>
                        import('./views/myClothes/ClothesList.vue'),
                    meta: { requiresAuth: true }
                },
                {
                    path: '/totalPrice',
                ...
                },
                {
                    ...
                    component: () =>
                        import('./views/maintenance/ShopMaintenance.vue'),
                    meta: { requiresAuth: true }
                },
                {
                    ...
                    component: () =>
                        import('./views/maintenance/BrandMaintenance.vue'),
                    meta: { requiresAuth: true }
                },
                {
                    ...
                    component: () =>
                        import('./views/maintenance/ClothesMaintenance.vue'),
                    meta: { requiresAuth: true }
                }
            ]
        }
...
router.beforeEach((to, _, next) => {
    if (to.matched.some(isRequiresAuth)) {
        ...
        const signedIn =
            store.getters[`${config.vuex.namespace.auths}/isSignedIn`];
